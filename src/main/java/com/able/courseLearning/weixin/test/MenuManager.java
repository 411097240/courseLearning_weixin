...
public class MenuManager {
	...
	private static Menu getMenu() {
		...
		btn11.setName("课堂签到");
		btn11.setType("view");
		btn11.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfc8eae6dd688043e&redirect_uri=http%3a%2f%2fweixin.411097240qqcom.yxnat.softdev.top%2fcourseLearning_weixin%2ftoStudentSgin&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect");
...
//		btn21.setUrl("http://www.baidu.com");
		...
		btn22.setName("课后练习题");
		btn22.setType("view");
		btn22.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfc8eae6dd688043e&redirect_uri=http%3a%2f%2fweixin.411097240qqcom.yxnat.softdev.top%2fcourseLearning_weixin%2ftoStudentIndex&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect");
